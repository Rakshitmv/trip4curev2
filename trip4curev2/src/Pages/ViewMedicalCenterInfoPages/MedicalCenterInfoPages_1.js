        ...
        <Container>
          ...
          <Row>
            <div className='col-md-8 mt-5  medical-center-menu-bar'>
              ...
              <Link to={'/view-medical-center/medical-center-info-page_1/medical-menu-bar-service'}><button type="button" class="line-primary-btn px-4 py-2 btn btn-outline-primary menu-bar-info">Services</button></Link>
              <Link to={'/view-medical-center/medical-center-info-page_1/medical-menu-bar-doctor'}><button type="button" class="line-primary-btn px-4 py-2 btn btn-outline-primary menu-bar-info">Doctors</button></Link>
            </div>
          </Row>
          <Row>
